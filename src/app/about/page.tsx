        ...
        <div className="mb-20">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-8">
            <div className="bg-orange-50 p-6 rounded-lg border border-orange-200">
              <h3 className="text-xl font-bold text-orange-900 mb-2">Letní sezóna</h3>
              <p className="text-sm text-orange-700 mb-3">1. července - 31. srpna</p>
              <p className="text-2xl font-bold text-orange-600">13 500 Kč</p>
              <p className="text-sm text-orange-700">za celý objekt / týden (SO-SO)</p>
            </div>

            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
              <h3 className="text-xl font-bold text-blue-900 mb-2">Mimo sezónu</h3>
              <p className="text-sm text-blue-700 mb-3">1. září - 30. června</p>
              <div className="space-y-2">
                <div>
                  <p className="text-xl font-bold text-blue-600">11 500 Kč</p>
                  <p className="text-sm text-blue-700">za celý objekt / týden</p>
                </div>
                <div>
                  <p className="text-xl font-bold text-blue-600">7 500 Kč</p>
                  <p className="text-sm text-blue-700">za celý objekt / víkend</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-red-50 p-6 rounded-lg border border-red-200">
              <h3 className="text-xl font-bold text-red-900 mb-2">🎉 Silvestr</h3>
              <p className="text-2xl font-bold text-red-600 mb-2">18 000 Kč</p>
              <p className="text-sm text-red-700">Týdenní pobyt - možnost upravení termínu</p>
            </div>

            <div className="bg-purple-50 p-6 rounded-lg border border-purple-200">
              <h3 className="text-xl font-bold text-purple-900 mb-2">🐰 Velikonoce</h3>
              <p className="text-2xl font-bold text-purple-600 mb-2">15 000 Kč</p>
              <p className="text-sm text-purple-700">cena za 4 noci</p>
            </div>
          </div>
